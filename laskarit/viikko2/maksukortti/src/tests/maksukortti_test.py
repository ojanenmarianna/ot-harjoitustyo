...
class TestMaksukortti(unittest.TestCase):
    ...
    def negatiivisen_summan_lataaminen_ei_muuta_kortin_saldoa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def kortilla_pystyy_ostamaan_edullisen_lounaan_kun_rahaa_vahan(self):
        self.kortti.syo_edullisesti
        self.kortti.syo_edullisesti
        self.kortti.syo_edullisesti
        self.kortti.syo_edullisesti
    ...
    def kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_rahaa_vahan(self):
